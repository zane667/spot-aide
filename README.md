...
演示脚本（约 3 分钟）：见 [docs/demo-script.md](docs/demo-script.md)。产品需求文档：见 [docs/prd.md](docs/prd.md)。核心 Prompt 迭代：见 [docs/prompt-iteration.md](docs/prompt-iteration.md)。模拟数据设计：见 [docs/data-design.md](docs/data-design.md)。竞品分析（点评 AI / 小红书 / 小团）：见 [docs/competitive-analysis.md](docs/competitive-analysis.md)。高保真原型（HTML，可导入 Figma / Axure）：见 [docs/prototype/](docs/prototype/)。美团 AI 产品 Builder 面试策略：见 [docs/interview-strategy.md](docs/interview-strategy.md)。
